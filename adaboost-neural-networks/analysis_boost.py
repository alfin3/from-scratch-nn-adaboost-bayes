...
file50n = os.path.abspath(os.path.join(basepath, 'Adaboost+NN 350e 50n',
                                       'adaboost+NN_350e_50n.csv'))
file125n = os.path.abspath(os.path.join(basepath, 'Adaboost+NN 350e 125n',
                                        'adaboost+NN_350e_125n.csv'))
